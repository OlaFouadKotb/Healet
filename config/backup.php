        ...
        'source' => [
            ...
            'databases' => [
                'mysql' => [
                    ...
                    'dump_command_path' => '', // Leave empty to use the default path
                    'dump_command_timeout' => 60 * 5, // 5 minutes timeout
                    'dump' => [
                        'excludeTables' => [
                            'table_to_exclude_from_backup',
                            'another_table_to_exclude',
                        ],
                        'addExtraOption' => '--skip-lock-tables --single-transaction', // Additional options for the dump command
                    ],
                ],
            ],
